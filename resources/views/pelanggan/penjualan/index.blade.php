...
<head>
    ...
    <title>Pelanggan | Riwayat Pembelian</title>
...
<body>
    <nav class="navbar">
        ...
        <div class="actions">
            <a href="{{ url('viewInsertPenjualanPelanggan') }}" class="btn-add">Beli Obat</a>
    ...
    <div class="container">
        <h2>Pelanggan | Riwayat Pembelian</h2>
        <table>
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                <?php $i = 1; ?>
                @foreach ($historyTransaksi as $row)
                    <tr>
                        <td><?= $i++ ?></td>
                        ...
                        <td>{{ $row->TOTAL }}</td>
                        <td>{{ $row->TANGGAL }}</td>
                        <td><a href="{{ url('cetakDetailSatuanPelanggan/' . $row->ID_PENJUALAN) }}"><button
